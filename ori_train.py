...
# -*- coding: utf-8 -*-
"""
Created on Thu Nov 12 17:24:52 2020
...
def corpus():
    ...
    """
    while True:
        with open('/media/liang/Nas/PreTrainModel/gpt/LCCC-large/LCCD.json') as f:
            for l in f:
                l = json.loads(l)
                yield l
...
# 补充词表
compound_tokens = []
for l in open('/media/liang/Project2/CCF-Baidu/nezha_gpt_dialog/user_tokens.csv', encoding='utf-8'):
